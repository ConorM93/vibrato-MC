function V = AnalyticVanillaCall(T, S, sigma, r, K, val )
...
%r - risk free rate
%K - Strike
%val - What we want, options are 'value', 'delta',
%'gamma', 'vega', 'vanna'

S  = max(1e-16,S);     % ensures no division by 0
K  = max(1e-16,K);     
...
%
% Normal cumulative distribution function for use above
%
function ncf = N(x)
